...
public class Player {
	...
	*/
	public double pcx, pcy, pwidth, pheight, pspeed;
	private Color cor;
	private String Id;
	...
	*/
	...
	public void draw(){
		...
		GameLib.fillRect(this.pcx, this.pcy, this.pwidth, this.pheight);
	}
	...
	*/
	...
	public void moveDown(long delta){
		if(this.pcy+(this.pheight/2)<this.v_limit[1])this.pcy += pspeed*delta;
	}
